...
// data
import { bhptCompany, bhType } from "../subMockData";
import Company from "./Company";
// component
const ProvinceSelect = React.lazy(() =>
  import("../subComponent/ProvinceSelect")
);
            ...
            <ul className="sc__services">
              ...
              <li className="sc__service">
                ...
                <div className="sc__step row">
                  ...
                  <div className="step__title">Chọn loại bảo hiểm</div>
                </div>

                {/* Row 2 - Step Content */}
                {/* Provider */}
                <Provider provider={bhType} />
              </li>
              {/* Step 3 */}
              <li className="sc__service">
                {/* Row 1 - Step Title */}
                ...
                <Form
                  ...
                  inputs={["Nhập mã danh bạ", "Số điện thoại liên hệ"]}
                />
              </li>
            </ul>
          </div>
